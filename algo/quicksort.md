...
tags:
  ...
  - Divide and Conquer
modifier: 'false'
modtime: '2017-12-06T03:10:13.864Z'
...
Best-case O(NlogN) The best case is when the pivot is the median of the array, and then the left and the right part will have same size.There are logN partitions, and to obtain each partitions we do N comparisons 
(and not more than N/2 swaps). 

Hence the complexity is O(NlogN)Average-case - O(NlogN){% endcapture %}
